...
const VirtualAssistant = () => {
  ...
  useEffect(() => {
    console.log("🤖 Assistant BoutiKonect v1.1.0 (Build: 2026-04-30) loaded.");
  }, []);
          ...
          >
            ...
            <div className="va-header">
              <div className="chat-header-info">
                ...
                <div>
                  <h3 style={{ margin: 0 }}>Assistant BoutiKonect <small style={{ fontSize: '10px', opacity: 0.7 }}>v1.1.0</small></h3>
