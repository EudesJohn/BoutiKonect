...
import { 
  checkIsAdmin, parseDate, cleanObject, mapItemFromDB, 
  getDistance, mapOrderFromDB, mapItemToDB, formatPrice 
} from './utils'
...
export const AppProvider = ({ children }) => {
  ...
  const memoizedParseDate = useCallback(parseDate, []);
  ...
  const value = {
    ...
    getCurrentLocation, formatPrice, parseDate: memoizedParseDate, checkIsAdmin,
