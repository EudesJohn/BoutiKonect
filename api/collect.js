...
module.exports = async (req, res) => {
  ...
  try {
    console.log('--- Démarrage de la collecte API ---');
    
    // Simulations de données immo (à remplacer par votre logique de scraping si besoin)
    const sampleProperties = [
      {
        title: 'Villa Moderne à Fidjrossè (API)',
