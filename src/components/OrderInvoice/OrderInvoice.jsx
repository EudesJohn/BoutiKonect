...
export default function OrderInvoice({
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      setPdfError("Génération PDF indisponible sur cet appareil. Utilisation de l'impression navigateur.")
    ...
    >
      ...
      <div className="invoice-document-wrapper" ref={invoiceRef}>
        <div className="invoice-document">
          ...
          {/* Status Badge */}
          <div className={`invoice-status ${paymentStatus === 'Payé' || paymentStatus === 'paid' ? 'paid' : 'pending'}`}>
            <span className="status-dot" />
            {paymentStatus === 'Payé' || paymentStatus === 'paid' ? 'Payée' : 'En attente de paiement'}
          </div>
          ...
          <div className="invoice-payment">
            ...
            <div className="payment-row">
              <span>Statut</span>
              <span className={`payment-status-badge ${paymentStatus === 'Payé' || paymentStatus === 'paid' ? 'paid' : 'pending'}`}>
                {paymentStatus === 'Payé' || paymentStatus === 'paid' ? 'Payé' : 'À payer à la livraison'}
              </span>
            </div>
          </div>
